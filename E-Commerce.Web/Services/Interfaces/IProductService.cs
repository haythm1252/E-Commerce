...
namespace E_Commerce.Web.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Task<PagedResult<Product>> SearchById(int id);
        Task<bool> AddAsync(CreateProductVM product);
        Task<bool> EditAsync(EditProductVM product);
        Task<bool> DeleteAsync(int id);
        Task<PagedResult<Product>> GetPagedAsync(int pageNumber, int pageSize, Expression<Func<Product, bool>>? criteria = null, params Expression<Func<Product, object>>[] includes);
    }
}
